...
export default function Home() {
  // --- your state + logic stays exactly the same ---
  ...
  // --------------------------------------------------------------------
  // ⭐ NEW: CLEAN ONE-PAGE LAYOUT WRAPPING YOUR EXISTING UI
  // --------------------------------------------------------------------
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-900 flex flex-col items-center px-4 py-10">
      ...
      <header className="max-w-2xl text-center mb-12">
        <h1 className="text-4xl font-bold mb-3">Windsor Gas Price Converter</h1>
        <p className="text-gray-600 text-lg">
          Convert US and Canadian gas prices instantly and calculate real savings based on your car.
        </p>
      </header>

      {/* --- GAS PRICE CONVERTER CARD --- */}
      <section className="w-full max-w-xl bg-white rounded-xl shadow-sm p-6 mb-12 space-y-4">
